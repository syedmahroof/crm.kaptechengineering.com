...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Edit State/Province</h1>
        ...
        <form action="{{ route('states.update', $state->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $state->name) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="code" id="code" value="{{ old('code', $state->code) }}" maxlength="10"
                ...
                <div>
                    <label for="is_active" class="flex items-center">
                        <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $state->is_active) ? 'checked' : '' }}
            ...
            <div class="mt-6 flex justify-end space-x-3">
                <a href="{{ route('states.index', ['country_id' => $state->country_id]) }}" class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200">
                    Cancel
                </a>
