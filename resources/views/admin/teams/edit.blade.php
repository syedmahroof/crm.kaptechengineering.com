            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div class="space-y-1">
                    ...
                    <select id="is_active" name="is_active"
                        ...
                        <option value="1" {{ old('is_active', $team->is_active) ? 'selected' : '' }}>Active</option>
                        <option value="0" {{ !old('is_active', $team->is_active) ? 'selected' : '' }}>Inactive</option>
                    </select>
                </div>
                    ...
                    <select id="team_lead_ids" name="team_lead_ids[]" multiple
                        ...
                        @foreach($teamLeads as $lead)
                            <option value="{{ $lead->id }}" 
                                    {{ in_array($lead->id, old('team_lead_ids', $team->teamLeads->pluck('id')->toArray())) ? 'selected' : '' }}>
