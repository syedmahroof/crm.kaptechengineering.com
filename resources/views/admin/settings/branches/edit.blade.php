            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="timezone" required class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white">
                        ...
                        <option value="America/New_York" {{ old('timezone', $branch->timezone) === 'America/New_York' ? 'selected' : '' }}>America/New_York (EST)</option>
                        <option value="America/Chicago" {{ old('timezone', $branch->timezone) === 'America/Chicago' ? 'selected' : '' }}>America/Chicago (CST)</option>
                        <option value="America/Denver" {{ old('timezone', $branch->timezone) === 'America/Denver' ? 'selected' : '' }}>America/Denver (MST)</option>
                        <option value="America/Los_Angeles" {{ old('timezone', $branch->timezone) === 'America/Los_Angeles' ? 'selected' : '' }}>America/Los_Angeles (PST)</option>
                        <option value="Europe/London" {{ old('timezone', $branch->timezone) === 'Europe/London' ? 'selected' : '' }}>Europe/London (GMT)</option>
                        <option value="Europe/Paris" {{ old('timezone', $branch->timezone) === 'Europe/Paris' ? 'selected' : '' }}>Europe/Paris (CET)</option>
                        <option value="Asia/Dubai" {{ old('timezone', $branch->timezone) === 'Asia/Dubai' ? 'selected' : '' }}>Asia/Dubai (GST)</option>
                        <option value="Asia/Kolkata" {{ old('timezone', $branch->timezone) === 'Asia/Kolkata' ? 'selected' : '' }}>Asia/Kolkata (IST)</option>
                        <option value="Asia/Singapore" {{ old('timezone', $branch->timezone) === 'Asia/Singapore' ? 'selected' : '' }}>Asia/Singapore (SGT)</option>
                        <option value="Asia/Tokyo" {{ old('timezone', $branch->timezone) === 'Asia/Tokyo' ? 'selected' : '' }}>Asia/Tokyo (JST)</option>
                        <option value="Australia/Sydney" {{ old('timezone', $branch->timezone) === 'Australia/Sydney' ? 'selected' : '' }}>Australia/Sydney (AEDT)</option>
                    </select>
                    @error('timezone')
                        <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                    @enderror
