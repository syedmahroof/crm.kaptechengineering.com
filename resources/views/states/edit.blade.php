<x-app-layout>
    ...
    <x-slot name="subtitle">Update state information</x-slot>
                    ...
                    <form action="{{ route('states.update', $state) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('code') is-invalid @enderror" 
                                   id="code" name="code" value="{{ old('code', $state->code) }}" maxlength="10" placeholder="e.g., AP">
                            @error('code')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save me-2"></i>Update State
                            </button>
