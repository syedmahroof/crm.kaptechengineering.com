<x-app-layout>
    ...
    <x-slot name="subtitle">Update city information</x-slot>
                    ...
                    <form action="{{ route('cities.update', $city) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('district') is-invalid @enderror" 
                                   id="district" name="district" value="{{ old('district', $city->district) }}" placeholder="District name">
                            @error('district')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save me-2"></i>Update City
                            </button>
